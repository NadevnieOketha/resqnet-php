...
<div class="page-header">
    <h1>Create Donation Appeal</h1>
    <a href="/dashboard/donations/manage" class="btn btn-outline">← Back</a>
</div>

<div class="card">
    <div class="card-body">
        <form method="POST" action="/dashboard/donations">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="needed_location" name="needed_location" value="<?= old('needed_location') ?>" required maxlength="180">
            </div>

            <div class="form-group">
                <label for="target_amount">Target Amount (LKR)</label>
                <input type="number" id="target_amount" name="target_amount" value="<?= old('target_amount') ?>" min="1" step="0.01" required>
            </div>

            <div class="form-group">
                <label for="status">Status</label>
                <?php $selectedStatus = old('status', 'open'); ?>
            ...
            <?php if (is_role('dmc_admin')): ?>
                <div class="form-group">
                    ...
                    <?php $selectedNgo = old('assigned_ngo'); ?>
