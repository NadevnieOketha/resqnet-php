...
('Admin User', 'admin@resqnet.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');

-- Moderator user (password: mod123)
INSERT INTO users (name, email, password, role) VALUES
('Moderator User', 'mod@resqnet.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'moderator');
